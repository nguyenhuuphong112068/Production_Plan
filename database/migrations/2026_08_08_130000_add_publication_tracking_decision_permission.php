...
return new class extends Migration
{
    ...
    private const PERMISSIONS = [
        [
            'name' => 'publication_tracking_decision_update',
            'display_name' => 'Quyết Định Theo Dõi Lên Ấn Bản',
            'description' => 'Chọn Có / Không thực hiện và ngày hoàn thành dự kiến ở cột Quyết Định',
        ],
    ];
