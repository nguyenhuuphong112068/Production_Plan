...
return new class extends Migration
{
    ...
    private const PERMISSIONS = [
        [
            'name' => 'publication_tracking_task_create',
            'display_name' => 'Tạo Nội Dung Theo Dõi Lên Ấn Bản',
            'description' => 'Dùng nút "Tạo nội dung theo dõi" để gán 1 nội dung cho nhiều mã BTP/TP cùng lúc',
        ],
        [
            'name' => 'publication_tracking_task_add',
            'display_name' => 'Thêm Nội Dung Theo Dõi Cho Từng Mã',
            'description' => 'Dùng nút "Thêm nội dung" trong ô để thêm nội dung theo dõi cho riêng 1 mã BTP/TP',
        ],
    ];
