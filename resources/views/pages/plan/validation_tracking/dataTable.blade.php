                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            @if (user_has_permission(session('user')['userId'], 'validation_tracking_update', 'boolean'))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else badge-secondary @endif"
                                                        style="cursor: pointer;" data-id="{{ $tracking->id }}"
                                                        ...
                                                        <ul class="list-group">
                                                            @foreach ($tracking->intermediateCategories as $ic)
                                                                <li
                                                                    ...
                                                                    <div>
                                                                        {{ $ic->intermediateCategory->intermediate_code ?? 'N/A' }}
                                                                        -
                                                                    ...
                                                                    <span
                                                                        class="badge badge-primary badge-pill btn-show-ic-plan-masters"
                                                ...
                                                <td>
                                                    @if (user_has_permission(session('user')['userId'], 'validation_tracking_approve', 'boolean'))
            ...
            <div class="modal fade" id="planMastersModal" tabindex="-1" role="dialog"
                aria-labelledby="planMastersModalLabel" aria-hidden="true">
                ...
                document.addEventListener('DOMContentLoaded', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                if (res && res.html) {
                                    ...
                                    $('#planMastersTableBody').html(
                                        '<div class="text-center p-3">Không có lô sản xuất nào được gắn</div>'
                                    );
                                }
                            },
                            error: function() {
                                $('#planMastersTableBody').html(
                                    '<div class="text-center text-danger p-3">Lỗi khi tải dữ liệu</div>');
                            }
                        });
                    }
                    ...
                    $('.btn-edit').on('click', function() {
                        ...
                        tracking.intermediate_categories.forEach(function(ic, index) {
                            let icCode = ic.intermediate_category ? ic.intermediate_category
                                .intermediate_code : ic.intermediate_category_id;
                            let icName = ic.intermediate_category && ic.intermediate_category.product_name ?
