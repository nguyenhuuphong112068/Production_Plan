            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class ="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="max_number_of_unit"
                                            id ="splitting_max_number_of_unit">

                                        <input type="number" class="form-control" name="number_of_unit"
                                            id="splitting_number_of_unit" placeholder="số lượng đóng gói"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-danger d-inline">
                                                            <input type="radio" id="splitting_level_1"
                                                                name="level" value = "1"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-warning d-inline">
                                                            <input type="radio" id="splitting_level_2"
                                                                name="level" value = "2"
                                                                {{ old('level') == 2 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-primary d-inline">
                                                            <input type="radio" id="splitting_level_3"
                                                                name="level" value = "3"
                                                                {{ old('level') == 3 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-success d-inline">
                                                            <input type="radio" id="splitting_level_4"
                                                                name="level" value = "4"
                                                                {{ old('level') == 4 ? 'checked' : '' }}>
                        ...
                        {{-- CÔng Thức ĐG --}}
                        <div class ="col-md-6">
                            <table id="data_table_packaging_splitting" class="table table-bordered table-striped"
