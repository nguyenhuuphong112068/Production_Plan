...
<!-- Modal -->
<div class="modal fade" id="qc_feedback_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <textarea 
                    ...
                    id="qc_feedback"
                    name="qc_feedback"
                    value="{{ old('qc_feedback') }}"
                    placeholder="Nhập phản hồi..."> </textarea>
              @error('qc_feedback', 'createErrors')
