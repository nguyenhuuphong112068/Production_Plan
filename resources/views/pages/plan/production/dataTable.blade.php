                  ...
                  @foreach ($datas as $data)
                    <tr>
                      ...
                      <td class="text-center align-middle position-relative">
                          <!-- Badge hiển thị số lượng history -->
                          <span class="badge badge-danger navbar-badge">{{ $data->history_count ?? 0 }}</span>
                          <!-- Nút history -->
                          <button type="button" class="btn btn-primary btn-history" 
                              data-id="{{ $data->id }}"
                              data-toggle="modal"
