            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class ="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="icheck-primary d-inline">
                                                        <input type="checkbox" class="step-checkbox"
                                                            id="update_checkbox1" name = "first_val_batch">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="icheck-primary d-inline">
                                                        <input type="checkbox" class="step-checkbox"
                                                            id="update_checkbox2" name = "second_val_batch">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="icheck-primary d-inline">
                                                        <input type="checkbox" class="step-checkbox"
                                                            id="update_checkbox3" name = "third_val_batch">
                        ...
                        {{-- CÔng Thức PC --}}
                        <div class ="col-md-4">
                            <table id="data_table_recipe" class="table table-bordered table-striped"
...
<script>
    $(document).ready(function() {
        ...
        $("#updateModal .step-checkbox").on("change", function() {
            ...
            let checkbox1 = modal.find("#update_checkbox1").is(":checked") ? 1 : 0;
            let checkbox2 = modal.find("#update_checkbox2").is(":checked") ? 1 : 0;
            let checkbox3 = modal.find("#update_checkbox3").is(":checked") ? 1 : 0;
            ...
            if (total > 0 && (!batch || batch.trim() === '')) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Nhập số lô trước khi chọn lô thẩm định update',
                    confirmButtonText: 'OK'
                });
