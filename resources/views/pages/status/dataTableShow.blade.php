...
@section('mainContent')
    ...
    <div>
        ...
        <div style="font-size: 16px; margin:0; text-align: center;">
            <span
                style="display: inline-block; width: 200px; height: 30px; background-color: #46f905; border: 1px solid #000; margin: 6px; line-height: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: 600;">
                Đang Sản Xuất
            </span>
            <span
                style="display: inline-block; width: 200px; height: 30px; background-color: #a1a2a2; border: 1px solid #000; margin: 6px; line-height: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: 600;">
                Đang Vệ Sinh
            </span>
            <span
                style="display: inline-block; width: 200px; height: 30px; background-color: #f99e02; border: 1px solid #000; margin: 6px; line-height: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: 600;">
                Đang Bảo Trì
            </span>
            <span
                style="display: inline-block; width: 200px; height: 30px; background-color: #ff0000; border: 1px solid #000; margin: 6px; line-height: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); color: white; font-weight: 600;">
                Máy Hư
            </span>
            <span
                style="display: inline-block; width: 200px; height: 30px; background-color: #ffffff; border: 1px solid #000; margin: 6px; line-height: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); font-weight: 600;">
                Không Sản Xuất
            </span>
        </div>
        ...
        <div class="text-white w-100 " style="background-color: #CDC717">
            <div class="animate-scroll inline-block text-xl text-red">
                <i class="nav-icon fas fa-capsules"></i> <<---
                    {{ $general_notication?->notification ?? 'Không có thông báo mới!' }} --->> <i
                        class="nav-icon fas fa-tablets"></i>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-striped" style="border: 3px solid #003A4F;">
                        ...
                        <tbody class="font-bold" style=" color:#003A4F; font-size: 24px;  padding: 5px; font-weight: bold">
                                        ...
                                        <td colspan="6">
                                            <div class="d-flex justify-content-between w-100">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    Thời gian cập nhật:
                                                    {{ $datetime ? \Carbon\Carbon::parse($datetime)->format('H:i d/m/Y') : '' }}
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                          ...
                          {{ $data->sheet }}
                                    ...
                                    <td style="max-width: 250px; overflow: hidden;">
                                        @if ($data->start_realtime && $data->end_realtime && $now->between($data->start_realtime, $data->end_realtime))
                                            <div>{{ \Carbon\Carbon::parse($data->start_realtime)->format('H:i d/m') }}
                                            </div>
