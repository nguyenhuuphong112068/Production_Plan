...
<script>
    $(document).ready(function() {
        $('.btn-history').off('click').on('click', function() {
            var id = $(this).data('id');
            $.ajax({
                url: "{{ route('pages.materData.productName.history') }}",
                type: "GET",
                data: { id: id },
                success: function(res) {
                    ...
                    if (current) {
                        ...
                        html += '<td class="text-center align-middle">' + (current.shortName !== null && current.shortName !== undefined ? current.shortName : '') + '</td>';
                        html += '<td class="text-center align-middle">' + (current.productType !== null && current.productType !== undefined ? current.productType : '') + '</td>';
                        html += '</tr>';
                        tbody.append(html);
                    }
                    ...
                    if(res.history.length === 0) {
                        ...
                        res.history.forEach(function(item) {
                            ...
                            html += '<td class="text-center align-middle">' + (item.shortName !== null && item.shortName !== undefined ? item.shortName : '') + '</td>';
                            html += '<td class="text-center align-middle">' + (item.productType !== null && item.productType !== undefined ? item.productType : '') + '</td>';
                            html += '</tr>';
                            tbody.append(html);
                        });
                    }
