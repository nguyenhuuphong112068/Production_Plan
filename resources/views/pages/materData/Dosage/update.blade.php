...
<div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form 
      ...
      action="{{route('pages.materData.Dosage.update')}}" 
      method="POST">
      @csrf
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title w-100 text-center" style="color: #CDC717">
              {{'Cập Nhật Dữ Liệu Gốc Dạng Bào Chế' }}
          </h4>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label for="name">Tên Dạng Bào Chế </label>
              <input type="text" class="form-control" name="name" 
                value="{{ old('name') }}">
            </div>
            @error('name', 'updateErrors')
                <div class="alUnitert alert-danger">{{ $message }}</div>
            @enderror
