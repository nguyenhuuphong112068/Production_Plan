          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button class="btn btn-success btn-create mb-2" data-toggle="modal" data-target="#intermediate_category" style="width: 155px" >
                    ...
                    <tr>
                      ...
                      <td class="text-center align-middle">  
                        ...
                        <form class="form-deActive" action="{{ route('pages.category.product.deActive') }}" method="post">
                            ...
                            @if ($data->active)
                              <button type="submit" class="btn btn-danger" data-type="{{ $data->active }}"  data-name="{{$data->finished_product_code ." - ". $data->intermediate_code ." - ". $data->product_name }}">
                                  <i class="fas fa-lock"></i>
                              </button>  
                            @else
                              <button type="submit" class="btn btn-success" data-type="{{ $data->active }}" data-name="{{$data->finished_product_code ." - ". $data->intermediate_code ." - ". $data->product_name }}">
