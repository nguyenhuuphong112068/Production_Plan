                                  ...
                                  <div class="form-group row align-items-center mb-2">
                                      <div class="col-md-12">
                                          <div class="icheck-primary">
                                              <input type="checkbox" id="update_has_packaging_process" name="has_packaging_process" value="1">
                                              <label for="update_has_packaging_process">Có xử lý bao bì không?</label>
                                          </div>
                                      </div>
                                  </div>
                                  @endif
...
<script>
    $(document).ready(function() {
        ...
        function updateInputs() {
            ...
            // Cốm sửa hạt khô đi kèm Pha Chế; để trống = không có biệt trữ
            const dryInput = $updateModal.find('.dry-granule-input');
            if ($updateModal.find('#update_checkbox2').is(':checked')) {
