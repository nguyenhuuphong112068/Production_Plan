            ...
            <form action="{{ route('pages.assignment.personnel.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="create_group_select" class="form-control" required>
                        ...
                        <input type="hidden" name="group_name" id="create_group_name">
                        <input type="hidden" name="group_code" id="create_group_code">
                    </div>
                </div>
