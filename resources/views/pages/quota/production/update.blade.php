...
<div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog custom-modal-size" role="document">
        ...
        <form action="{{ route('pages.quota.production.update') }}" method="POST">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="C2_time" value="{{ old('C2_time') }}"
                                    placeholder="HH:mm" pattern="^(?:\d{1,2}|1\d{2}|200):(00|15|30|45)$"
                                    title="Nhập giờ hợp lệ">
                            </div>
