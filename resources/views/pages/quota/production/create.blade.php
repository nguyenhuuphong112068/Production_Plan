...
<div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog custom-modal-size" role="document">
        ...
        <form id="createQuotaForm" action="{{ route('pages.quota.production.store') }}" method="POST">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                @error('product_name', 'create_Errors')
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="intermediate_code" id ="intermediate_code"
                                readonly value="{{ old('intermediate_code') }}" />
                            <input type="text" class="form-control" name="finished_product_code"
                                id ="finished_product_code" readonly value="{{ old('finished_product_code') }}" />
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="select2" multiple="multiple" data-placeholder="Select a State"
                                    id ="room_id" style="width: 100%; height: 50mm" name="room_id[]">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="p_time" value="{{ old('p_time') }}"
                                    placeholder="HH:mm" pattern="^(?:\d{1,2}|1\d{2}|200):(00|15|30|45)$"
                                    title="Nhập giờ hợp lệ">
                            </div>
                            @error('p_time', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="m_time" value="{{ old('m_time') }}"
                                    placeholder="HH:mm" pattern="^(?:\d{1,2}|1\d{2}|200):(00|15|30|45)$"
                                    title="Nhập giờ hợp lệ">
                            </div>
                            @error('m_time', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="C1_time" value="{{ old('C1_time') }}"
                                    placeholder="HH:mm" pattern="^(?:\d{1,2}|1\d{2}|200):(00|15|30|45)$"
                                    title="Nhập giờ hợp lệ">
                            </div>
                            @error('C1_time', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="C2_time"
                                    value="{{ old('C2_time') }}" placeholder="HH:mm"
                                    pattern="^(?:\d{1,2}|1\d{2}|200):(00|15|30|45)$" title="Nhập giờ hợp lệ">
                            </div>
                            @error('C2_time', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="code">Số lô chiến dịch tối đa</label>
                            ...
                            @error('maxofbatch_campaign', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        @if ($stage_code <= 2)
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="note"
                                    value="{{ old('note') }}" placeholder="Ghi chú nếu có">
                            </div>
                            @error('note', 'create_Errors')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#room_id').on('change', function() {
            ...
            let finished_product_code = $("#finished_product_code").val();
