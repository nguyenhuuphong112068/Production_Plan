                        ...
                        <div class="col-md-12 d-flex gap-2">
                            <div class="form-group d-flex align-items-center">
                                <form id="filterForm" method="GET"
                                    action="{{ route('pages.report.maintenance_weekly_report.index') }}">
                                    @csrf
                                    <div class="d-flex align-items-center">
                                        <label for="reportedDate" class="mr-2 mb-0">Chọn Tuần:</label>
                                        <input type="week" id="reportedDate" name="reportedDate"
                                        ...
                                        <tr class="{{ $stageId }}">
                                            ...
                                            @foreach ($weekDays as $day)
                                                <td class="align-top p-2"
                                                    style="min-height: 80px; background-color: {{ Carbon::now()->format('Y-m-d') == $day['date'] ? '#fff9c4' : 'transparent' }};">
                                                    @php
...
<style>
    ...
    #maintenance_weekly_table thead th {
    ...
    #maintenance_weekly_table thead tr:nth-child(1) th {
        top: 0;
    }
    ...
    #maintenance_weekly_table th,
    #maintenance_weekly_table td {
