...
class MaintenanceWeeklyReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Lấy dữ liệu bảo trì (stage_code = 8)
        $datas = DB::table('room as r')
            ...
            ->select(
                ...
                'qm.parent_eqp_id',
                'qm.block',
                DB::raw("CASE WHEN qm.block = 'TI-B1' OR qm.block = 'TI-B2' THEN 'Tiện ích' 
                              WHEN qm.type = 2 THEN 'Bảo Trì' 
                              WHEN qm.type = 1 THEN 'Hiệu chuẩn' 
