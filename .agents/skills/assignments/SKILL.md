...
- 🔬 **Hai giả thuyết ĐÃ THỬ VÀ SAI, đừng làm lại:** ngày 18/09/2026 eO2 chỉ cho qua khoảng **5 request** rồi chặn cái thứ 6, và (a) hạ `max_concurrency` 3 → 2 không giúp gì (vẫn đúng 1 trong 6 chết, endpoint chết chỉ đổi chỗ từ `overtime`/15 sang `leave`/17 → không phải giới hạn số kết nối đồng thời); (b) cắt mẻ 3+3 với 10s nghỉ cũng không giúp (lượt 11:53:40 vẫn chết request thứ 6 → cửa sổ tính của eO2 dài hơn ~90s). Mức này chặt hơn nhiều so với ~24 request/175s đo được 18/08/2026, nên rất có thể eO2 siết dần theo số lần đã bị chặn trong ngày.
